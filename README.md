...
1. Создать локальный репозиторий (*Локальный репозиторий - это папка на вашем компьютере. Она является клоном той, что находится на сервере Git*) на компьютере и потом отправить его на сервер (классика 😎)
2. Создать репозиторий на сайте и сделать клон (Проще 🤷🏼‍♂️)
...
**Важно!**  
Домашние задания загружить на СДО, в самом низу страницы есть ссылка.
